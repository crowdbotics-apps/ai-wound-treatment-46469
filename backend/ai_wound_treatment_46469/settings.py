"""
Django settings for ai_wound_treatment_46469 project.
...
ROOT_URLCONF = 'ai_wound_treatment_46469.urls'
...
WSGI_APPLICATION = 'ai_wound_treatment_46469.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ai_wound_treatment_46469 API",
    "DESCRIPTION": "API documentation for ai_wound_treatment_46469 App",
    "VERSION": "v1",
}
